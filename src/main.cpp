...
uint256 hashGenesisBlock("0xf117ea6b57125bfd9e0d0ea57e00e69751a043e239e15ef5aa1c5a8d57ff4662");
...
static const int64 nTargetTimespan = 1 * 60; // Learncoin: 1 minute
static const int64 nTargetSpacing = 2.5 * 30; // Learncoin: 30seconds
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf117ea6b57125bfd9e0d0ea57e00e69751a043e239e15ef5aa1c5a8d57ff4662");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "learcoin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1476016533;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1945192;
